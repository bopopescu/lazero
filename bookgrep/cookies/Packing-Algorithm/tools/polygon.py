...
'''
2.6 所有的平移和处理全部换为精准计算，bias主要处理计算精度导致的差异
'''
bias=0.00001
...
def tryNFP():
    ...
    #     for j in range(0,7):
    #         print(i,j)
    #         poly1=json.loads(df['polygon'][i])
    #         poly2=json.loads(df['polygon'][j])
...
def polygonFuncCheck():
    # poly1=[[1385.8696491364888, 462.99004169471357], [1192.6844838786747, 711.2262326742094], [909.8417714040562, 694.0689451488284], [806.3141533630477, 307.69861463320115], [1140.9206748581705, 218.041067416396], [1475.527196353294, 128.38352019959018]]
    # poly2=[[1197.34, 721.53], [902.05, 703.61], [794.07, 300.63], [1721.43, 52.14], [1489.67, 114.24], [1395.0, 467.53]]
    # simi_poly1=GeoFunc.similarPoly(poly1)
    # GeoFunc.slidePoly(poly1,300,0)
    # PltFunc.addLine([[923.2050807568877, 649.9999999999999], [923.2050807568878, 850.0]])
    # PltFunc.addLine([[-1330.8323775877034, 917.7495658272355], [2669.1676224122966, 917.7495658272333]])
...
def getData():
    ...
    '''暂时没有考虑宽度，全部缩放来表示'''
    scale=[100,0.5,100,100,20,20,20,10,20,20,0.5,20,50,1,1,1,1,1,1,1]
