...
lx=list(pos.keys())
y_true={i:random.choice([0,1]) for i in range(len(lx))}
# # print(fx)
# # pos0={x:posx[lx[x]] for x in range(len(lx))}
# draw_communities(Gx, fx, posx)
# plt.show() # dammit.
# # print(pos)
# # tralslator.
