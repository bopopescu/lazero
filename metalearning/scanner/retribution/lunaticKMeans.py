    ...
    def fit(self, data):
        ...
        # fuck you!
            ...
            for classification in self.classes:
                self.centroids[classification] = statistics.mean(self.classes[classification])
            ...
            for centroid in self.centroids:
                ...
                if ((curr - original_centroid)/original_centroid * 100.0) > self.tolerance:
                    isOptimal = False
...
#    colors = 10*["r", "g", "c", "b", "k"]
    return [km.pred(x) for x in X]
    # return this function for usage?
