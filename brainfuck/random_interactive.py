...
def the_loop(a):
    ...
    # 连接服务器
    ssh.connect(hostname='192.168.43.52', port=23,
                username='tc', password='')
...
# def metaGen():
#     s = [chr(x) for x in range(200)]
#     s1 = [1, 2, 3, 4, 5, 6, 7]
#     s2 = "".join([random.choice(s) for x in range(random.choice(s1))])
#     return s2
#     # remember to press the enter?
    # s="0123456789QWERTYUIOPASDFGHJKLZXCVBNM_-+="
    # you can actually increase your vocab.
# def metaloop(a):
...
#     # r1 = windowEndMarkEx(r, 10)
#     # print(r1)
#     # very strange.
#     # not too damn much.
#     # you want this.
#     # rx = len(r)
#     # you can dynamically feed this.
#     # for x in r1:
#     rx = 0
#     while True:
#         # you can also use the architecture.
#         # p=Pool(the_loop,x)
#         print("trial:", rx)
#         r = [metaGen() for x in range(BATCH_SIZE)]
#         rx += len(r)
#         # print(rx, "items left")
#         print("diet:", r)
#         p = parallel(the_loop, r) # the answer?
#         initial("projects",p)
#         # what the heck.
#         # for y in x:
#         #     f.update({y: True})
...
#     print("THE END!")
# # rebuild the thing.
# # reattaching needs for the screen command.
